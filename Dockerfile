...
RUN cd /usr/local/etc/raddb/mods-available && wget https://raw.githubusercontent.com/ryanistryin/freeradius3-docker/master/mods-available/rest && cd ../mods-enabled/ && ln -s /usr/local/etc/raddb/mods-available/rest .
